...
std::vector<MenuStates> rootMenuTitles(bool includeSpeaker, bool includeScene, bool includeSensor, bool includeKodi, bool includeLight,
                                       bool includeSwitch) {
