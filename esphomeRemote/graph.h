...
class GraphTrace {
 public:
  ...
  const void set_tracedata(HistoryData data) { data_ = data; }
  // end homeThing
...
class NewHistoryData : public HistoryData {
    public:
        void setData(std::vector<float> samples) {samples_ = samples;}
};
class NewGraphTrace : public GraphTrace {
    public:
